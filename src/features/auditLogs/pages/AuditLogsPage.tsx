...
export default function AuditLogsPage() {
  ...
  const apply = () => { setPagination((current) => ({ ...current, page: 0 })); setFilters({ actorId: actorId || undefined, entityType: entityType.trim() || undefined, entityId: entityId.trim() || undefined, action: action.trim() || undefined, startDate: startDate || undefined, endDate: endDate || undefined }); };
